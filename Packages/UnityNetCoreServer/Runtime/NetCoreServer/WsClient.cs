...
namespace NetCoreServer
{
  ...
  public class WsClient : HttpClient, IWebSocket
  {
    ...
    public WsClient(IPAddress address, int port) : base(address, port)
    {
    ...
    /// <param name="address">IP address</param>
    /// <param name="port">Port number</param>
    public WsClient(string address, int port) : base(address, port)
    {
      WebSocket = new WebSocket(this);
    }
    ...
    public WsClient(DnsEndPoint endpoint) : base(endpoint)
    {
      WebSocket = new WebSocket(this);
    }
