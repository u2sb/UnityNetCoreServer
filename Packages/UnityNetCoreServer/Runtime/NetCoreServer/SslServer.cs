...
namespace NetCoreServer
{
  ...
  public class SslServer : IDisposable
  {
    ...
    public SslServer(SslContext context, DnsEndPoint endpoint) : this(context, endpoint, endpoint.Host, endpoint.Port)
    {
    }
    ...
    public SslServer(SslContext context, IPEndPoint endpoint) : this(context, endpoint, endpoint.Address.ToString(),
      endpoint.Port)
    {
    }
    ...
    private SocketAsyncEventArgs _acceptorEventArg = null!;
