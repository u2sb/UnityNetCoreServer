...
namespace NetCoreServer
{
  ...
  public class SslClient : IDisposable
  {
    ...
    /// <param name="address">IP address</param>
    /// <param name="port">Port number</param>
    public SslClient(SslContext context, string address, int port) : this(context,
    ...
    public SslClient(SslContext context, DnsEndPoint endpoint) : this(context, endpoint, endpoint.Host, endpoint.Port)
    {
    }
    ...
    public SslClient(SslContext context, IPEndPoint endpoint) : this(context, endpoint, endpoint.Address.ToString(),
      endpoint.Port)
    {
    }
    ...
    private SocketAsyncEventArgs _connectEventArg = null!;
    ...
    public virtual bool Connect()
    {
      ...
      try
      {
        ...
        _sslStream = new SslStream(new NetworkStream(Socket, false), false, Context.CertificateValidationCallback);
    ...
    private void TrySend()
    {
      ...
      try
      {
        ...
        _sslStream.BeginWrite(_sendBufferFlush.Data, (int)_sendBufferFlushOffset,
          (int)(_sendBufferFlush.Size - _sendBufferFlushOffset), ProcessSend, _sslStreamId);
      }
      catch (ObjectDisposedException)
      {
      }
    ...
    private void ProcessConnect(SocketAsyncEventArgs e)
    {
      ...
      if (e.SocketError == SocketError.Success)
      {
        ...
        try
        {
          ...
          IsHandshaking = true;
          _sslStream.BeginAuthenticateAsClient(Address, Context.Certificates, Context.Protocols, true,
