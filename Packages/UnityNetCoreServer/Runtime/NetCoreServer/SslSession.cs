  ...
  public class SslSession : IDisposable
  {
    ...
    internal void Connect(Socket socket)
    {
      ...
      try
      {
        ...
        _sslStream.BeginAuthenticateAsServer(Server.Context.Certificate, Server.Context.ClientCertificateRequired,
          Server.Context.Protocols, false, ProcessHandshake, _sslStreamId);
      }
      catch (Exception)
      {
    ...
    private Buffer _receiveBuffer = new Buffer();
