...
{
  /// <summary>
  ///   HTTPS server is used to create secured HTTPS Web server and communicate with clients using secure HTTPS protocol. It
  ///   allows to receive GET, POST, PUT, DELETE requests and send HTTP responses.
  /// </summary>
  ...
  public class HttpsServer : SslServer
  {
    ...
    public HttpsServer(SslContext context, DnsEndPoint endpoint) : base(context, endpoint)
    {
      Cache = new FileCache();
    }
