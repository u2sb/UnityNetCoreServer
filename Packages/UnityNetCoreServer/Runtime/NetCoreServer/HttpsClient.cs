...
{
  /// <summary>
  ///   HTTPS client is used to communicate with secured HTTPS Web server. It allows to send GET, POST, PUT, DELETE requests
  ///   and receive HTTP result using secure transport.
  /// </summary>
  ...
  public class HttpsClient : SslClient
  {
    ...
    public HttpsClient(SslContext context, DnsEndPoint endpoint) : base(context, endpoint)
    {
      Request = new HttpRequest();
      Response = new HttpResponse();
    }
  ...
  public class HttpsClientEx : HttpsClient
  {
    ...
    public Task<HttpResponse> SendRequest(TimeSpan? timeout = null)
    {
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendHeadRequest(string url, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakeHeadRequest(url), timeout);
    }
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendGetRequest(string url, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakeGetRequest(url), timeout);
    }
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendPostRequest(string url, string content, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakePostRequest(url, content), timeout);
    }
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendPutRequest(string url, string content, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakePutRequest(url, content), timeout);
    }
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendDeleteRequest(string url, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakeDeleteRequest(url), timeout);
    }
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendOptionsRequest(string url, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakeOptionsRequest(url), timeout);
    }
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendTraceRequest(string url, TimeSpan? timeout = null)
    {
      return SendRequest(Request.MakeTraceRequest(url), timeout);
    }
    ...
    protected override void OnHandshaked()
    {
      ...
      if (Request is { IsEmpty: false, IsErrorSet: false })
        if (!SendRequestAsync())
          SetResultError("Failed to send HTTP request!");
    }
