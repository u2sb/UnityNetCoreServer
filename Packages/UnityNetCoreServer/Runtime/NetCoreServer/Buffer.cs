...
namespace NetCoreServer
{
  ...
  public class Buffer
  {
    ...
    {
      return new ReadOnlySpan<byte>(Data, (int)Offset, (int)Size);
    }

    public Memory<byte> AsMemory()
    {
      return new Memory<byte>(Data, (int)Offset, (int)Size);
    }

    public ReadOnlyMemory<byte> AsReadOnlyMemory()
    {
      return new ReadOnlyMemory<byte>(Data, (int)Offset, (int)Size);
    }
    ...
    {
      return Append(buffer.AsReadOnlySpan());
    }
